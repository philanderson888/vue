...
```powershell
cd \github\vue\projects\;vue create vue-authentication-firebase-04; cd vue-authentication-firebase-04;yarn install;yarn serve
```

## Run

```powershell
clear;cd C:\github\vue\projects\vue-authentication-firebase-05;yarn serve
```
